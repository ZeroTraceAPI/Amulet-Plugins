...
categories = {
    "Building Blocks": {
        ...
        "Glass": [173, 190, 1082, 1230, 1829],
        "Stained_Glass": [174, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 1827],
        "Glass_Panes": [192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 1828, 1830],
        ...
        "Bricks": [272, 273, 274, 275, 277, 278, 279, 284, 285, 286, 289, 352, 357, 365, 366, 367, 369, 370, 473, 767, 768, 769, 770, 1461],
        "Blackstone": [280, 281, 514, 521, 1664, 1681],
        "Basalt": [517, 524, 525],
        "Tuff": [288, 516, 523],
        "Copper_Blocks": [303, 304, 305, 306, 348],
        "Amethyst_Blocks": [728, 1463],
        "Prismarine": [356, 358, 1464],
        "Nether_Bricks": [368],
        "Nylium": [477, 478],
    },
    "Natural Blocks": {
        "Logs": [530, 531, 532, 533, 534, 535, 536, 537, 538, 539, 540, 541, 542, 543, 544, 545, 546, 547, 548, 549, 550, 551, 570, 571, 572, 573, 750, 1850, 1865],
        ...
        "Saplings": [587, 588, 589, 590, 591, 592, 593, 594, 595],
        "Mushroom_Blocks": [748, 749],
        "Ores": [491, 492, 493, 494, 495, 496, 497, 498, 499, 500, 502, 503, 504, 505, 506, 507, 508, 509, 1847],
        "Raw_Blocks": [210, 301, 302, 343, 344, 345, 346, 347, 349, 350, 351, 354, 360, 361, 362, 363, 364, 371, 470, 474, 475, 481, 574, 575, 612, 711, 714, 716, 722, 865, 874, 875, 876, 877, 878, 879, 880, 881, 882, 883, 1441, 1648, 1811, 1815, 1816, 1871],
    },
    "Rails": {
        "Rails": [1639, 1640],
    },
    "Redstone": {
        "Redstone_Components": [1641, 1642, 1645, 1649, 1650, 1651, 1652, 1653, 1654, 1655, 1656, 1657, 1658, 1659, 1660, 1661, 1662, 1663, 1666, 1667, 1668, 1669, 1670, 1671, 1672, 1673, 1674, 1675, 1676, 1677, 1678, 1679, 1680, 1682, 1684, 1685, 1686, 1687, 1688, 1690, 1691, 1806, 1862, 1863, 1864, 1874],
        "Lamps": [1380, 1846],
    },
    "Farming": {
        "Crops": [597, 598, 599, 600, 601, 603, 604, 605, 606, 607, 608, 613, 614, 617, 618, 619, 694, 1011, 1013, 1015, 1019, 1855, 1856, 1857],
        "Food": [610, 611, 1009, 1010, 1012, 1016],
        "Animal_Products": [752, 753, 772, 773, 774, 780, 781, 782, 783, 784, 785, 786, 787, 788, 789, 790, 791, 792, 793, 794, 795, 796, 797, 798, 799, 800, 801, 802, 803, 804, 805, 806, 807, 808, 809, 810, 811, 812, 813, 814, 815, 816, 817, 818, 819, 820, 821, 822, 823, 824, 825, 826, 827, 828, 829, 830, 831, 832, 833, 834, 835, 836, 837, 838, 839, 840, 841, 842, 843, 844, 845, 846, 847, 848, 849, 850, 851, 852, 853, 854, 855, 856, 857, 858, 859, 860, 1002, 1003, 1004, 1005, 1376, 1853],
    },
    "Mob Drops": {
        "Monster_Drops": [639, 649, 1018, 1029, 1030, 1031, 1032, 1033, 1034, 1035, 1036, 1375, 1430, 1431, 1432, 1433, 1434, 1435, 1436, 1437, 1465, 1467, 1468, 1469, 1478, 1479, 1486, 1487, 1489, 1492],
        "Heads": [1423, 1424, 1425, 1426, 1427, 1428, 1429],
    },
    "Weapons": {
    ...
    "Armor": {
        "Armor": [891, 892, 893, 894, 895, 896, 897, 898, 899, 900, 901, 902, 903, 904, 905, 906, 907, 908, 909, 910, 911, 912, 913, 914, 915, 916, 917, 918, 1079],
    },
    "Horse_Armor": {
        "Horse_Armor": [1073, 1074, 1075, 1076, 1077],
    },
    "Fireworks": {
        "Fireworks": [1764, 1765, 1766, 1767, 1768, 1769, 1770, 1771, 1772, 1773, 1774, 1775, 1776, 1777, 1778, 1779, 1780],
        "Star": [1491, 1781, 1782, 1783, 1784, 1785, 1786, 1787, 1788, 1789, 1790, 1791, 1792, 1793, 1794, 1795, 1796],
    },
    "Containers": {
        "Shulker_Boxes": [1328, 1329, 1330, 1331, 1332, 1333, 1334, 1335, 1336, 1337, 1338, 1339, 1340, 1341, 1342, 1343, 1344],
        "Bundles": [1056, 1057, 1058, 1059, 1060, 1061, 1062, 1063, 1064, 1065, 1066, 1067, 1068, 1069, 1070, 1071, 1072],
        "Chests": [1316, 1317, 1318, 1319, 1320, 1321, 1322, 1323, 1324, 1325, 1326, 1644],
        "Barrel": [1327],
    },
    "Miscellaneous": {
        "Dyes": [676, 677, 678, 679, 680, 681, 682, 683, 684, 685, 686, 687, 688, 689, 690, 691],
        "Buckets": [1413, 1414, 1415, 1416, 1417, 1418, 1419, 1420, 1421, 1422],
        ...
        "Music_Discs": [1356, 1357, 1358, 1359, 1360, 1361, 1362, 1363, 1364, 1365, 1366, 1367, 1368, 1369, 1370, 1371, 1372, 1373, 1374],
        "Boats": [1619, 1620, 1621, 1622, 1623, 1624, 1625, 1626, 1627, 1628, 1629, 1630, 1631, 1632, 1633, 1634, 1635, 1636, 1637, 1638],
        "Beds": [863, 1233, 1234, 1235, 1236, 1237, 1238, 1239, 1240, 1241, 1242, 1243, 1244, 1245, 1246, 1247, 1248, 1820, 1833],
        "Signs": [1382, 1383, 1384, 1385, 1386, 1387, 1388, 1389, 1390, 1391, 1392, 1393, 1876],
        "Hanging_Signs": [1394, 1395, 1396, 1397, 1398, 1399, 1400, 1401, 1402, 1403, 1404, 1405],
        "Banners": [1695, 1696, 1697, 1698, 1699, 1700, 1701, 1702, 1703, 1704, 1705, 1706, 1707, 1708, 1709, 1710, 1711, 1712, 1713, 1714, 1715, 1716, 1717, 1718, 1719, 1720, 1721],
        "Spawners": [760, 761],
        "Coral": [630, 631, 632, 633, 634, 640, 641, 642, 643, 644],
        "Dead_Coral": [635, 636, 637, 638, 645, 646, 647, 648],
        "Enchanted_Books": [1497, 1498, 1499, 1500, 1501, 1502, 1503, 1504, 1505, 1506, 1507, 1508, 1509, 1510, 1511, 1512, 1513, 1514, 1515, 1516, 1517, 1518, 1519, 1520, 1521, 1522, 1523, 1524, 1525, 1526, 1527, 1528, 1529, 1530, 1531, 1532, 1533, 1534, 1535, 1536, 1537, 1538, 1539, 1540, 1541, 1542, 1543, 1544, 1545, 1546, 1547, 1548, 1549, 1550, 1551, 1552, 1553, 1554, 1555, 1556, 1557, 1558, 1559, 1560, 1561, 1562, 1563, 1564, 1565, 1566, 1567, 1568, 1569, 1570, 1571, 1572, 1573, 1574, 1575, 1576, 1577, 1578, 1579, 1580, 1581, 1582, 1583, 1584, 1585, 1586, 1587, 1588, 1589, 1590, 1591, 1592, 1593, 1594, 1595, 1596, 1597, 1598, 1599, 1600, 1601, 1602, 1603, 1604, 1605, 1606, 1607, 1608, 1609, 1610, 1611, 1612, 1613, 1614, 1615, 1616, 1617, 1618],
    },
}
armor_item_range = {
    0: [618, 891, 892, 893, 894, 895, 896, 897, 1079, 1423, 1424, 1425, 1426, 1427, 1428, 1429],
    1: [898, 899, 900, 901, 902, 903, 904, 1080],
    2: [905, 906, 907, 908, 909, 910, 911],
    3: [912, 913, 914, 915, 916, 917, 918],
}
color_dict = {
            0: 'black',
            8: 'gray',
...
class RemapVillagers(wx.Frame):
    ...
    def calculate_village_boundaries(self, clusters, radius=64):
        """
            ...
            for ik,iv in v.items():
                ...
                if 'minecraft:villager_v2' in  act_nbt.get('identifier', StringTag()).py_str:
                    ...
                    act_nbt['definitions'] = ListTag([
                        ...
                        StringTag('+gather_schedule_villager'),
                        StringTag('-job_specific_goals'),
                        StringTag('+adult'),
                        StringTag('+behavior_non_peasant'),
                        StringTag('+work_schedule_villager'),
                        StringTag('+work_schedule')
                    ])
    ...
    def reset_vaults(self):
        ...
        for chunk in chunks:
            ...
            if self.world.level_wrapper.platform == 'bedrock':
                ...
                try:
                    self.level_db.delete(key + b'w') # Ox77
                except:
                    pass
                try:
